...
## References
- [Author - Dean Attali](https://deanattali.com) or [Dean Attali - consulting website](https://attalitech.com) 
- [Demo pages built using this theme](https://beautifuljekyll.com)
- [Examples websites](http://beautifuljekyll.com/examples)
